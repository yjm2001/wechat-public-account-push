...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx08ed62860f39cfe8',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '253061e32cc68a650d2ff4ddb0d42ec2',
  ...
  USERS: [
    {
      ...
      id: 'otHp06CCqSohY_8jPUKTC1gsHRKc',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'Bc5gy6AX9cbzPm7BOfooFzix3O6pJq9-bZi4xrLt4aw',
      // 所在省份或城市，也可以不填
      province: '阿克苏',
      // 所在城市或县区
      city: '温宿',
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
         ...
         {
          type: '节日', name: '周年纪念日', year: '2021', date: '09-19',
        },
